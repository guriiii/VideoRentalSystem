...
namespace VideoRentalSystem
{
    public partial class ViewCustomer : Form
    {
        ...
        {
            dataGridView1.DataSource = new DatabaseFunctions().findallcustomers();//customer list
        }

        private void DataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)//showing the data in update form
        {
